    ...
    return (
      <div className='container my-5'>
        <div className='empty-cart flex justify-center align-center flex-column font-manrope'>
          ...
          <Link to = "/" className='shopping-btn bg-orange text-white fw-5'>Compra ahora</Link>
        </div>
      </div>
    )
  }
        ...
        <div className='cart-ctable'>
          <div className='cart-chead bg-white'>
            <div className='cart-ctr fw-6 font-manrope fs-15'>
              ...
              <div className='cart-cth'>
                <span className='cart-ctxt'>Precio unitario</span>
              </div>
              <div className='cart-cth'>
          ...
          <div className='cart-cfoot flex align-start justify-between py-3 bg-white'>
            <div className='cart-cfoot-l'>
              <button type='button' className='clear-cart-btn text-danger fs-15 text-uppercase fw-4' onClick={() => dispatch(clearCart())}>
                ...
                <span className='mx-1'>Vacíar carrito</span>
              </button>
            </div>
            ...
            <div className='cart-cfoot-r flex flex-column justify-end'>
              ...
              <button type = "button" className='checkout-btn text-white bg-orange fs-16'>Verificar</button>
            </div>
          </div>
        </div>
      </div>
